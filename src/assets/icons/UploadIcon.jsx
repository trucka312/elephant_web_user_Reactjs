...
export default function UploadIcon({ className, ...rest }) {
  return (
    <svg
      width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" className={`${className}`} {...rest}
    >
      <g>
        <g>
          <g>
